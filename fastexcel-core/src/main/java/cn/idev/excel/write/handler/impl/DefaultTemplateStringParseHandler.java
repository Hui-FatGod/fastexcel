...
public class DefaultTemplateStringParseHandler implements TemplateStringParseHandler {
    ...
    private volatile static DefaultTemplateStringParseHandler instance;

    public synchronized static DefaultTemplateStringParseHandler getInstance() {
        if (instance == null) {
    ...
    public Collection<TemplateStringPart> parse(String value) {
        ...
        while (startIndex < length) {
            ...
            TemplateStringPart variableGapPart = TemplateStringPart.text(lastPartIndex == prefixIndex
                ? StringUtils.EMPTY : processEscape(value.substring(lastPartIndex, prefixIndex)));
        ...
        TemplateStringPart trailingPart = TemplateStringPart.text(lastPartIndex == length ?
            StringUtils.EMPTY : processEscape(value.substring(lastPartIndex)));
